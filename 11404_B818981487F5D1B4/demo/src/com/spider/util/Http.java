...
//            Map<String, String> cookies = res.cookies();
     ...
     * @return String
     */
    public static String httpGetSpider(String url, Map<String, String> paramsMap, Map<String, String> headerMap, Map<String, String> cookies) {
        //休眠指定时间
        sleepTime();
        try {
            //获取连接
...
//            String responseText = resp.body();
     ...
     * @return String
     */
    public static String httpPostSpider(String url, Map<String, String> paramsMap, Map<String, String> headerMap, Map<String, String> cookies) {
        //休眠指定时间
        sleepTime();
        try {
            //获取连接
