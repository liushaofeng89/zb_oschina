package com.spider.util;//import sun.misc.BASE64Decoder;
...
//            BASE64Encoder base64en = new BASE64Encoder();
            requestValue = ApacheBase64.encodeBase64String(src);
...
//            BASE64Decoder base64Decode = new BASE64Decoder();
            byte[] base64DValue = ApacheBase64.decodeBase64(URLValue);
            //要进行3-DES加密的内容在进行/"UTF-16LE/"取字节
    ...
    public static void main(String[] args) {
        ...
        String reValue = Endecrypt.get3DESEncrypt(oldString, SPKEY);
        reValue = reValue.trim().intern();
        System.out.println("进行3-DES加密后的内容: " + reValue);
        String reValue2 = Endecrypt.get3DESDecrypt(reValue, SPKEY);
