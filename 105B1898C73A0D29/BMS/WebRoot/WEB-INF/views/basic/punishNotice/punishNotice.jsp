...
<script type="text/javascript">
	...
	function viewFun(viewType) {
		...
		var title = '', href = '${ctx}/punishNotice/viewPage?viewType='+ viewType;
		var buttons = [];
		if ('add' == viewType) {
			title = '租车登记';
			buttons = [ {
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="toolbar" class="mygrid-toolbar" style="inline: true">
		...
		<c:choose>
			<c:when
				test="${fn:contains(sessionInfo.resourceList, '/punishNotice/add')}">
		...
		<c:choose>
			<c:when
				test="${fn:contains(sessionInfo.resourceList, '/punishNotice/detail')}">
