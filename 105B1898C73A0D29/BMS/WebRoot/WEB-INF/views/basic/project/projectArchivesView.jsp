...
<script type="text/javascript">
	...
	$(function() {
		$('#projectAppropriateRegViewForm').form({
			url : '${pageContext.request.contextPath}/projectArchives/save?viewType=${viewType}',
			onSubmit : function() {
				progressLoad();
			...
			<table class="grid">
				<tr>
					...
					<td colspan="5"><input id="projectAppRegId" type="hidden"
						value="${projectArchives.id}"></input> <input type="hidden"
						name="id" id="id" value="${projectArchives.id}" /> <input
						name="projectName" style="width: 100%; height: 100%" type="text"
						id="projectName" class="easyui-validatebox span2"
						data-options="required:true"
						value="${projectArchives.projectName}" /></td>
				</tr>
				<tr>
					<th>中标价（元） &nbsp;<label
						style="color: red; vertical-align: middle; text-align: center;">*</label></th>
					<td><input name="bidPrice" style="width: 100%; height: 100%"
						...
						data-options="required:true"
						value="${projectArchives.bidPrice}" /></td>
					<th>中标日期 &nbsp;<label
						style="color: red; vertical-align: middle; text-align: center;">*</label></th>
					<td><input class="Wdate" type="text" name="bidDT" id="bidDT"
						style="width: 98%; height: 100%;"
						value="<fmt:formatDate value="${projectArchives.bidDT}" pattern="yyyy-MM-dd"/>"
				...
				<tr>
					<th>合同工期（天） &nbsp;<label
						style="color: red; vertical-align: middle; text-align: center;">*</label></th>
					<td>
					<fmt:parseNumber var="contractDuration" integerOnly="true" type="number" value="${projectArchives.contractDuration}" />
					...
					<td><input name="managerFeeRate"
						...
						value="${projectArchives.managerFeeRate}"
					...
					<td><input name="managerFee" style="width: 100%; height: 100%"
						...
						value="${projectArchives.managerFee}" /></td>
				</tr>
				<tr>
